        ...
        <div class="space-y-6">
          <div class="bg-white p-8 rounded-[40px] shadow-xl shadow-blue-900/5 border border-slate-100">
            ...
            <div class="mt-10 space-y-4">
              <button class="w-full py-5 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-2xl shadow-xl shadow-blue-600/20 transition-all hover:scale-[1.02] active:scale-[0.98]">
